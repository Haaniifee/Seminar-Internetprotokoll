...
vorgelegt von
\vspace*{0.4cm}\\
\textbf{Fulya Cankaya:} fulya-cankaya@hotmail.de \\ \textbf{ Hanife Demircioglu:} h.demircioglu@hotmail.de \\ 
\end{center}
\vspace*{3.9cm}
...
Die empfangenen Datenpakete durchlaufen diesen Algorithmus bis das Datenpaket zugeordnet oder weitergeleitet werden kann.
